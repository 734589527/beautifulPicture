 ...
 */
public class One_photo_share
{
    public Bitmap showBitmap(Bitmap bitmaps,float width,float heigh,Bitmap frame1,Bitmap frame2,Bitmap frame3,Bitmap frame4)
    {
        try
        {
            int W=(int)(heigh/3*0.9);
            int H=(int) ((float)W / frame1.getWidth() * frame1.getHeight());
            Log.e("tagss", String.valueOf(width));
            Log.e("tagss",String.valueOf(heigh));
            Log.e("tagss",String.valueOf(W));
            Log.e("tagss",String.valueOf(H));
            for(int i=0;i<3;i++) {
            ...
            Log.e("tagss",String.valueOf(bitmaps.getHeight()));
            Log.e("tagss",String.valueOf(bitmaps.getWidth()));
